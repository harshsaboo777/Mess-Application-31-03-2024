      ...
      <div class="">
        <div class="max-w-2xl mx-auto text-white py-10">
          <div class="text-center">
            <h3 class="text-3xl mb-3"> Download Healthy Mealz App </h3>
          ...
          <div class="mt-15 flex flex-col md:flex-row md:justify-between items-center text-sm text-gray-100">
            <p class="order-2 md:order-1 mt-8 md:mt-0">
              {" "}
              &copy; Healthy Mealz, 2023.{" "}
            </p>
