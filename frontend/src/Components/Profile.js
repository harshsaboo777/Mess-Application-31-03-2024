...
{subscribed_mess.filter(ele => ele.status == 0).map(ele => (
  ...
  />
            ...
            {/* <Card3 messName="Sharma Mess" address="64, Ram Nagar, Indore" numberOfTiffins={1} status={"Delivered"}/>
            <Card3 messName="Pandit Jii Mess" address="Flat-46, Sethi Nagar, Khandwa" numberOfTiffins={5} status={"Delivered"}/>
            <Card3 messName="Shukla Mess" address="46, Sethi Nagar, Khandwa" numberOfTiffins={1} status={"Delivered"}/> */}
            </div>
